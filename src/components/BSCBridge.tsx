                ...
                <div className="col-lg-12">
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="judul-roadmap margin-b">
                                <h1 className="text-bridge">AVALANCHE / BSC SPORE BRIDGE</h1>
                            </div>
                        </div>
                    ...
                    <div className="wrapBridge pt-2">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <div className="input-group-append">
                                                <button className="btn btn-outline-secondary approved" onClick={setMaxSporeAVAX} type="button">MAX</button>
                                            </div>
                                        </div>
                                        <div className="offset-lg-3 col-lg-6 text-center mt-3">
                                            <button onClick={approve} className="btn btn-primary approved" id="approve-btn">APPROVE</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card px-lg-5 rounded-0 h-100 binance">
                                    <div className="card-body">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <div className="input-group-append">
                                                <button className="btn btn-outline-secondary approved" type="button" onClick={setMaxSporeBSC}>MAX</button>
                                            </div>
                                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12 text-center py-4 col-coin">
                                <p> Transfer fees : {feesAVAX} AVAX </p>
                                <button onClick={swapFromAVAX} className="btn btn-primary claimair m-l" id="swap-btn">Transfer</button>
                            </div>
                            <div className="col-lg-12 text-center py-4 col-coin d-none">
                                <p> Transfer fees : {feesBNB} BNB </p>
                                <button onClick={swapFromBSC} className="btn btn-primary claimair m-l" id="swap-btn">Transfer</button>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-12 text-center py-4">
                                <h5><img src="warnings.png" width="50" height="50" alt="" /> This is a version alpha. Use at your own risk please come to discord if you have an issue.</h5>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-12 text-center py-4">
                            <button className="btn btn-primary claimair m-l" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                HOW TO BRIDGE &#127812;
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="collapse" id="collapseExample">
                        <div className="card card-body">
                            <div className="offset-lg-3 col-lg-6 py-4">
