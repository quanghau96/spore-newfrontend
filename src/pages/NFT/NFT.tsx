...
const NFT = (props: any) => {
  ...
  return (
    <>
      <section className="information-outer">
        <div className='container information py-2'>
          <div className='row pb-5 py-2'>
            <div className='col-lg-12'>
              <div className="judul-roadmap margin-b">
                <h1 className="text-roadmap m-nft"><b>NFT Version 1</b></h1>
                <h3 className="h-nft">Vision, Pricing & Fair Launch</h3>
                <h3 className="p-nft">Welcome to Our First Generation of NFTs</h3>
              </div>
        ...
        <div className="container py-5 claimnft">
          <div className="row">
            <div className="col-md-12 col-lg-6 col-sm-12 align-self-center">
              <div>
                <h3 className="text-center">Claim your NFT and spread the Spore !</h3>
                <br />
                <p className="mb-1">
                ...
                <div className="input-group mb-3">
                  <input type="number" id="_approveFee" className="form-control" defaultValue="10000000000000" aria-label="Recipient's username" aria-describedby="button-addon2" />
                  <button onClick={approve} className="btn btn-outline-secondary approved" id="button-addon2">Approve</button>
                </div>
                ...
                <p className="text-center">
                  <button onClick={claim} className="btn btn-secondary btn-lg px-5 py-2 text-uppercase approved">Claim your NFT</button>
                </p>
              </div>
            </div>
          </div>
      ...
      <section className='bg-grey'>
        <div className="container information py-5">
          <div className='row py-5'>
            <div className="judul-roadmap m-market">
              <h1 className="text-roadmap"><b>Marketplace</b></h1>
              <h3 className="p-roadmap">Marketplace of NFTs SPORE</h3>
            </div>
          ...
          < div className="row" >
            <h3 className="text-center mb-4">Buy NFT and spread the Spore !</h3>
            <div className="col-md-12 col-lg-6 col-sm-12">
              <div className="input-group">
                ...
                <div className="input-group-append">
                  <button onClick={approve} className="btn btn-primary approved">Approve Fee</button>
                </div>
              </div>
              <p className="text-muted">
            ...
            <div className="col-md-12 col-lg-6 col-sm-12">
              <div className="input-group">
                ...
                />
                <div className="input-group-append">
                  <button onClick={NFTbuy} className="btn btn-primary approved">Buy NFT</button>
                </div>
              </div>
            </div>
          </div >
        ...
        isWeb3 ? (
          <section className="bg-grey py-5">
            <div className="container">
              ...
              {
                isnetworkID ? (<div className="text-center">{image}</div>) :

                  (<div className="text-center"> <UnlockMetamask message="Wrong Network, please switch" /> </div>)
              }
            </div>
          </section>
        )
